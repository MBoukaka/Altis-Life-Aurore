...
//Compose message
//_message = composeText [ image "icons\insigne.paa", lineBreak, lineBreak, name player, lineBreak, "Altis Police Department" ];
_message = format["<img size='10' color='#FFFFFF' image='images\police_gold.paa'/><br/><br/><t size='2.5'>%1</t><br/><t size='1.5'>%2</t><br/><t size='1'>Aurore Gendarmerie</t>", name player, _rank];
