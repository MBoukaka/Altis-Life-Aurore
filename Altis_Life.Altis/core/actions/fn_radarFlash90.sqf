...
if((round _speed > 95) && (round _speed < 101)) then {_pay = 90;};
if((round _speed > 100) && (round _speed < 115)) then {_pay = 180;};
if(round _speed > 114) then {_pay = 500;};
...
if((round _speed > 95) && (round _speed < 101)) then {
if(CASH >= _pay) then {
...
if((round _speed > 100) && (round _speed < 115)) then {
if(CASH >= _pay) then {
cutText[format[" !!! Vous avez été flashé à %1 km/h !!! \n\n\n Vous écopez d'une amende de %2 € retirés de votre compte bancaire !",round _speed,[_pay] call life_fnc_numberText],"WHITE OUT"];
0.0001 cutFadeOut 5;
sleep 0.7;
