...
class VirtualItems {
	...
	VITEMMACRO(lockpick, "STR_Item_Lockpick", "lockpick", 5, 150, 75, false, -1, "aurore_data2\icons\items\lockpick.paa")
	...
	VITEMMACRO(salt_refined, "STR_Item_SaltR", "saltRefined", 2, -1, 1450, false, -1, "aurore_data2\icons\items\salt.paa")
	VITEMMACRO(sand, "STR_Item_Sand", "sand", 3, -1, -1, false, -1, "aurore_data2\icons\items\sand.paa")
	VITEMMACRO(glass, "STR_Item_Glass", "glass", 2, -1, 1450, false, -1, "aurore_data2\icons\items\glass.paa")
	...
	VITEMMACRO(poudre, "STR_Item_poudre", "poudre", 4, -1, -1, false, -1, "")
	...
	//Drink
	VITEMMACRO(redgull, "STR_Item_RedGull", "redgull", 2, 1500, 200, false, 100, "aurore_data2\icons\items\redgull.paa")
	VITEMMACRO(coffee, "STR_Item_Coffee", "coffee", 2, 10, 5, false, 100, "aurore_data2\icons\items\coffee.paa")
	VITEMMACRO(waterBottle, "STR_Item_WaterBottle", "waterBottle", 1, 10, 5, false, 100, "aurore_data2\icons\items\water.paa")

	//Food
	VITEMMACRO(apple, "STR_Item_Apple", "apple", 2, 65, 50, false, 10, "aurore_data2\icons\items\apple.paa")
	VITEMMACRO(peach, "STR_Item_Peach", "peach", 2, 68, 55, false, 10, "aurore_data2\icons\items\peach.paa")
	VITEMMACRO(tbacon, "STR_Item_TBacon", "tbacon", 1, 75, 25, false, 40, "aurore_data2\icons\items\meat.paa")
	VITEMMACRO(donut, "STR_Item_Donuts", "donut", 2, 120, 60, false, 30, "aurore_data2\icons\items\donuts.paa")
	...
	VITEMMACRO(hen_raw, "STR_Item_HenRaw", "henRaw", 2, -1, 35, false, -1, "icons\food.paa")
	VITEMMACRO(hen_fried, "STR_Item_HenFried", "henFried", 3, 115, 85, false, 65, "icons\ico_cookedMeat.paa")
	VITEMMACRO(rooster_raw, "STR_Item_RoosterRaw", "roosterRaw", 2, -1, 35, false, -1, "icons\food.paa")
	VITEMMACRO(rooster_grilled, "STR_Item_RoosterGrilled", "roosterGrilled", 115, 110, 85, false, 45, "icons\ico_cookedMeat.paa")
