...
class VirtualItems {
	//Misc
	VITEMMACRO(menotte, "STR_Item_Menotte", "menotte", 3, 26, -1, true, -1, "aurore_data2\icons\items\handcuffs.paa")
	...
	VITEMMACRO(blastingcharge, "STR_Item_BCharge", "blastingCharge", 10, 7000, -1, true, -1, "aurore_data2\icons\items\blastingcharge.paa")
	VITEMMACRO(boltcutter, "STR_Item_BCutter", "boltCutter", 5, 9500, -1, true, -1, "aurore_data2\icons\items\boltcutter.paa")
	...
	VITEMMACRO(marijuana, "STR_Item_Marijuana", "marijuana", 3, -1, 0, true, -1, "aurore_data2\icons\items\marijuana.paa")
	VITEMMACRO(resine, "STR_Item_resine", "resine", 3, -1, 0, true, -1, "aurore_data2\icons\items\marijuana.paa")
	...
	VITEMMACRO(tbacon, "STR_Item_TBacon", "tbacon", 2, 8, -1, false, 40, "aurore_data2\icons\items\meat.paa")
	...
	VITEMMACRO(rabbit_grilled, "STR_Item_RabbitGrilled", "rabbitGrilled", 4, -1, 150, false, 20, "icons\ico_cookedMeat.paa")
	VITEMMACRO(salema_raw, "STR_Item_Salema", "salemaRaw", 3, -1, -1, false, -1, "aurore_data2\icons\items\fish.paa")
	VITEMMACRO(salema_grilled, "STR_Item_SalemaGrilled", "salemaGrilled", 2, 6, 5, false, 30, "icons\ico_cookedMeat.paa")
	VITEMMACRO(ornate_raw, "STR_Item_OrnateMeat", "ornateRaw", 3, -1, -1, false, -1, "aurore_data2\icons\items\fish.paa")
	VITEMMACRO(ornate_grilled, "STR_Item_OrnateGrilled", "ornateGrilled", 2, 6, 5, false, 25, "icons\ico_cookedMeat.paa")
	VITEMMACRO(mackerel_raw, "STR_Item_MackerelMeat", "mackerelRaw", 4, -1, -1, false, -1, "aurore_data2\icons\items\fish.paa")
	VITEMMACRO(mackerel_grilled, "STR_Item_MackerelGrilled", "mackerelGrilled", 2, 20, 18, false, 30, "icons\ico_cookedMeat.paa")
	VITEMMACRO(tuna_raw, "STR_Item_TunaMeat", "tunaRaw", 6, -1, -1, false, -1, "aurore_data2\icons\items\fish.paa")
	VITEMMACRO(tuna_grilled, "STR_Item_TunaGrilled", "tunaGrilled", 3, 150, 125, false, 100, "icons\ico_cookedMeat.paa")
	VITEMMACRO(mullet_raw, "STR_Item_MulletMeat", "mulletRaw", 4, -1, -1, false, -1, "icons\food.paa")
	VITEMMACRO(mullet_fried, "STR_Item_MulletFried", "mulletFried", 2, 60, 40, false, 80, "icons\ico_cookedMeat.paa")
	VITEMMACRO(catshark_raw, "STR_Item_CatSharkMeat", "catsharkRaw", 6, -1, -1, false, -1, "aurore_data2\icons\items\fish.paa")
