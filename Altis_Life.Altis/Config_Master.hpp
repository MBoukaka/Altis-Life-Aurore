...
class VirtualItems {
	...
	VITEMMACRO(bijoux, "STR_Item_bijoux", "bijoux", 2, -1, 0, false, -1, "aurore_data2\icons\items\diamond.paa")
	...
	VITEMMACRO(pute, "STR_Item_pute", "pute", 100, -1, 340, true, -1, "")
	VITEMMACRO(puteluxe, "STR_Item_puteluxe", "putelux", 100, -1, 340, true, -1, "")
...
class Licenses {
	...
	LICENSEMACRO(avion,"STR_License_avion","avion",6500,false,"civ")
	LICENSEMACRO(dive,"STR_License_Diving","dive",350,false,"civ")
	LICENSEMACRO(gun,"STR_License_Firearm","gun",4000,false,"civ")
	LICENSEMACRO(coastguard,"STR_License_CG","cg",200,false,"cop")
	...
	LICENSEMACRO(bijoux,"STR_License_bijoux","bijoux",3500,false,"civ")
	LICENSEMACRO(salt,"STR_License_Salt","salt",1200,false,"civ")
	LICENSEMACRO(cocaine,"STR_License_Cocaine","cocaine",10500,false,"civ")
	LICENSEMACRO(cocaineup,"STR_License_cocaineup","cocaineup",10500,false,"civ")
	...
	LICENSEMACRO(heroinup,"STR_License_Heroinup","heroinup",7500,true,"civ")
	...
	LICENSEMACRO(michto,"STR_License_michto","michto",750,false,"civ")
	LICENSEMACRO(VNC,"STR_License_VNC","VNC",750,false,"civ")
	LICENSEMACRO(dozen,"STR_License_dozen","dozen",750,false,"civ")
	LICENSEMACRO(mikhailov,"STR_License_mikhailov","mikhailov",750,false,"civ")
	LICENSEMACRO(kenzy,"STR_License_kenzy","kenzy",750,false,"civ")
	LICENSEMACRO(neavys,"STR_License_neavys","neavys",750,false,"civ")
