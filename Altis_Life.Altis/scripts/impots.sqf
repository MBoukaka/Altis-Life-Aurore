...
[] spawn {
	...
	{
		sleep 300;
		if (life_atmbank > 500000) then {hint "Impots sur la fortunes dans 5 minutes.";};
		sleep 300;
		if (license_civ_rebel OR license_civ_bandit) then {
			switch (true) do 
			{
				...
				{
					life_atmbank = life_atmbank - 4500;
					hint parseText format ["<t color='#FFCC00'><t size='2'><t align='center'>IMPOTS<br/><t color='#ffffff'>Tu viens de payer 4500 d'impots."];
				};
				...
				case (life_atmbank > 4000000) : 
				{
					...
					hint parseText format ["<t color='#FFCC00'><t size='2'><t align='center'>IMPOTS<br/><t color='#ffffff'>Tu viens de payer 20000 d'impots."];
				};
			};
		} else {
			switch (true) do 
			{
				...
				case (life_atmbank > 2500000 && life_atmbank <= 3000000) : 
				{
					...
					hint parseText format ["<t color='#FFCC00'><t size='2'><t align='center'>IMPOTS<br/><t color='#ffffff'>Tu viens de payer 10000 d'impots."];
				};
				case (life_atmbank > 3000000 && life_atmbank <= 4000000) : 
				{
					life_atmbank = life_atmbank - 13500;
					hint parseText format ["<t color='#FFCC00'><t size='2'><t align='center'>IMPOTS<br/><t color='#ffffff'>Tu viens de payer 13500 d'impots."];
				};
				case (life_atmbank > 4000000) : 
				{
					life_atmbank = life_atmbank - 17500;
					hint parseText format ["<t color='#FFCC00'><t size='2'><t align='center'>IMPOTS<br/><t color='#ffffff'>Tu viens de payer 17500 d'impots."];
				};
			};
		};
