	...
	*/	
	...
	class reb_car {
		...
		vehicles[] = {
			...
			{ "cl3_golf_mk2_camo_urban", 4000, "rebel" },
			{ "cl3_golf_mk2_camo", 4000, "rebel" },
			{ "cl3_civic_vti_camo_urban", 4000, "rebel" },
			{ "cl3_polo_gti_camo_urban", 3500, "rebel" },
			{ "cl3_polo_gti_camo", 3500, "rebel" },
			{ "cl3_defender_110_cammo", 3800, "rebel" },
			{ "cl3_escalade_camo_urban", 8000, "rebel" },
			{ "cl3_escalade_camo", 8000, "rebel" },
			{ "cl3_xr_1000_camo", 14200, "rebel" },
			{ "cl3_enduro_camo_urban", 14200, "rebel" },
			{ "cl3_enduro_camo", 14200, "rebel" },
			{ "cl3_taurus_camo", 32500, "rebel" },
			{ "cl3_taurus_camo_urban", 32500, "rebel" },
			{ "cl3_impreza_road_camo_urban", 72500, "rebel" },
			...
			{ "cl3_carrera_gt_camo", 92500, "rebel" },
			{ "cl3_dbs_volante_camo_urban", 92500, "rebel" },
			{ "cl3_dbs_volante_camo", 92500, "rebel" },
			{ "cl3_e60_m5_camo", 92500, "rebel" },
			{ "cl3_e60_m5_camo_urban", 92500, "rebel" },
			{ "cl3_e63_amg_camo", 92500, "rebel" },
			{ "cl3_e63_amg_camo_urban", 92500, "rebel" },
			{ "cl3_insignia_camo_urban", 92500, "rebel" },
			{ "cl3_insignia_camo", 92500, "rebel" },
			{ "cl3_q7_camo_urban", 92500, "rebel" },
			{ "cl3_q7_camo", 92500, "rebel" },
			{ "cl3_s5_camo_urban", 92500, "rebel" },
			{ "cl3_s5_camo", 92500, "rebel" },
			{ "cl3_impreza_rally_camo_urban", 125000, "rebel" },
			{ "cl3_impreza_rally_camo", 125000, "rebel" },
			{ "cl3_r8_spyder_camo_urban", 100000, "rebel" },
			{ "cl3_reventon_camo_urban", 100000, "rebel" },
			{ "cl3_reventon_camo", 100000, "rebel" },
			{ "cl3_murcielago_camo_urban", 100000, "rebel" },
			{ "cl3_murcielago_camo", 100000, "rebel" },
	...
	class cop_car {
		...
		vehicles[] = {
			...
			{ "Orel_Rangoo", 2250, "" },
			{ "DAR_CVPIAux", 2500, ""},
			{ "DAR_CVPIPolice", 2500, "", { "life_coplevel", 2 } },
			{ "DAR_CVPISlick", 2500, "", { "life_coplevel", 2 } },
			{ "cl3_enduro_police", 500, "", { "life_coplevel", 2 } },
			{ "cl3_xr_1000_police", 500, "", { "life_coplevel", 2 } },
			{ "Orel_Master", 3500, "", { "life_coplevel", 2 } },
			{ "DAR_ImpalaPolice", 4000, "", { "life_coplevel", 2 } },
			{ "DAR_ImpalaPoliceSlick", 4000, "", { "life_coplevel", 2 } },
			{ "DAR_ImpalaPoliceDet", 4000, "", { "life_coplevel", 2 } },
			{ "Orel_Payenne", 5050, "", { "life_coplevel", 2 } },
			{ "DAR_TaurusPolice", 8500, "", { "life_coplevel", 3 } },
			{ "DAR_TaurusPoliceState", 8500, "", { "life_coplevel", 3 } },
			{ "DAR_TaurusPoliceStateSlick", 8500, "", { "life_coplevel", 3 } },
			{ "A3L_GrandCaravanUCBlack", 9000, "", { "life_coplevel", 3 } },
			{ "DAR_ExplorerPolice", 9500, "", { "life_coplevel", 3 } },
			{ "DAR_ExplorerPoliceStealth", 9500, "", { "life_coplevel", 3 } },
			{ "DAR_TahoePolice", 9500, "", { "life_coplevel", 3 } },
			{ "DAR_TahoePoliceSlick", 9500, "", { "life_coplevel", 3 } },
			{ "DAR_ChargerPolice", 10500, "", { "life_coplevel", 4 } },
			{ "DAR_ChargerPoliceState", 10500, "", { "life_coplevel", 4 } },
			{ "DAR_ChargerPoliceStateSlick", 10500, "", { "life_coplevel", 4 } },
	...
	class aurore {
		...
		vehicles[] = {
			...
			{ "cl3_arielatom_camo_urban", 130000, "", { "life_donator", 3 } },
			{ "cl3_arielatom_camo", 130000, "", { "life_donator", 3 } },
