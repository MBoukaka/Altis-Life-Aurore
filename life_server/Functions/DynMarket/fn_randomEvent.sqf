...
DYNMARKET_Events =
[
	["Les zones petrolieres debordent, le prix en bourse vient d'exploser !",["oil_processed"],-1],	// -1 MEANS CHANGE PRICE TO MAX, -2 TO MIN, OR A VALUE TO WHICH THE PRICE BE CHANGED TO
	["D'apres nos experts, la temperature actuelle provoquerait de la moisissure dans les champs de houblons. Le business de l'heroine a sans doute chute !",["heroin_processed"],-2]
];
