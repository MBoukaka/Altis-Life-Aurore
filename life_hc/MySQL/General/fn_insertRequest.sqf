...
if(typeName _queryResult == "STRING") exitWith {[[],"SOCK_fnc_dataQuery",(_returnToSender),false] call life_fnc_MP;}; //There was an entry!
...
[[],"SOCK_fnc_dataQuery",(_returnToSender),false] call life_fnc_MP;